    ...
    <div class="container">
        ...
        <aside v-if="menuStatus" class="left-wrapper">
          <div class="left-wrapper-fixed">
            <div class="user-wrapper">
              <img src="../static/images/face.jpg" @click="changeMenu('admin','/login')">
              <p class="user-name">Banana</p>
              <p class="user-email">Code Create Life</p>
            </div>
            <div class="menu-wrapper">
              <ul>
                ...
                <li :class="{'li-active':active=='about'}" @click="changeMenu('about','/about')">
                  <i class="iconfont icon-Archives"></i>
                  <p>About</p>
                </li>
                <li class="" @click="See('https://github.com/yangyezhuang')">
      ...
      <div class="main-wrapper">
        <div class="nav-wrapper" :class="{'nav-shadow':navShadow}">
          <i class="iconfont" :class="{'icon-close move-right' :menuStatus, 'icon-menu move-left':!menuStatus}"
             @click="asideStatus()"></i>
          <i class="iconfont icon-share"></i>
          <i class="iconfont icon-search search-i" :class="{'search-opacity':searchStatus}"
             @click="searchStatus = !searchStatus"></i>
